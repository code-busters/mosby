            ...
            <c:forEach items="${ticketsInfo}" var="ticket">
                <div id="${ticket.id}" class="row">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="my-modal-label-${ticket.id}"><fmt:message
                                            key="editTicketsPromoCodes.ticketSettings"/></h4>
                                </div>
                    ...
                    <div id="falldown-${ticket.id}" class="falldown col-md-12">
                        <div class="form-group">
                            <label for="ticket-description-${ticket.id}"><fmt:message
                                    key="editTicketsPromoCodes.ticketDescription"/></label>
                            <textarea rows="3"
                        ...
                        <div class="form-group">
                            <label for="ticket-datepicker-start-${ticket.id}"><fmt:message
                                    key="editTicketsPromoCodes.startDateTimeForTicket"/></label>

                            <div class="input-prepend input-datepicker">
                                <button type="button" class="btn">
                                    <span class="fui-calendar"></span>
                                </button>
                                <input value="${ticket.startDate}" type="text" placeholder=""<fmt:message
                                    key="editTicketsPromoCodes.startDate"/>" name="ticket_start_date_${ticket.id}"
                                id="ticket-datepicker-start-${ticket.id}" readonly="" >
                            </div>
                            <input type="time" class="form-control time" value="${ticket.startTime}" placeholder="00:00"
                                   name="ticket_start_time_${ticket.id}">
                        </div>

                        <div class="form-group">
                            <label for="ticket-datepicker-end-${ticket.id}"><fmt:message
                                    key="editTicketsPromoCodes.endDateTimeForTicket"/></label>

                            <div class="input-prepend input-datepicker">
                                <button type="button" class="btn">
                                    <span class="fui-calendar"></span>
                                </button>
                                <input value="${ticket.endDate}" type="text" placeholder=""<fmt:message
                                    key="editTicketsPromoCodes.endDate"/>" name="ticket_end_date_${ticket.id}"
                                id="ticket-datepicker-end-${ticket.id}" readonly="" >
                            </div>
                            <input type="time" class="form-control time" value="${ticket.endTime}" placeholder="00:00"
        ...
        <div id="promo-codes-body">
            ...
            <c:forEach items="${promoCodes}" var="promoCode">
                <div id="${promoCode.id}" class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <label class="visible-xs" for="promo-code-code-${promoCode.id}"><fmt:message
                                key="editTicketsPromoCodes.promoCode"/></label>
                        <input type="text" class="form-control"
                    ...
                    <div class="col-md-2 col-sm-2 actions text-center">
                        <label class="visible-xs text-left"><fmt:message
                                key="editTicketsPromoCodes.actions"/></label>
                        <a id="open-falldown" href="#fakelink">
                            <span class="fui-new"></span>
                        </a>
                        <a class="delete-nearby-row" href="#">
                    ...
                    <div id="falldown-${promoCode.id}" class="falldown col-md-12">
                        ...
                        <div class="form-group">
                            <label for="promo-code-description-${promoCode.id}"><fmt:message
                                    key="editTicketsPromoCodes.promoCodeDescription"/></label>
                            <textarea rows="3"
