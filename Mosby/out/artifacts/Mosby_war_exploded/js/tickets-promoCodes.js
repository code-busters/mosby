    ...
    $(document).ready(function () {
        ...
        var addTicket = function (priceInput) {
            ...
            $('#tickets > #tickets-body:last').append(
                    ...
                    '<input type="date" class="form-control" placeholder="Start date For Ticket" name="ticket_start_date_' + id + '" id="ticket-datepicker-start-' + id + '">' +
                    ...
                    '<input type="date" class="form-control" placeholder="End date For Ticket" name="ticket_end_date_' + id + '" id="ticket-datepicker-end-' + id + '">' +
