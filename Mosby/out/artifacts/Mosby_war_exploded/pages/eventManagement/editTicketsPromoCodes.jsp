                        ...
                        <div id="falldown-${ticket.id}" class="falldown col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control"
                                       placeholder="<fmt:message key="editTicketsPromoCodes.startDate"/>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control"
                                       placeholder="<fmt:message key="editTicketsPromoCodes.endDate"/>"
                            ...
                            <div class="form-group">
                                ...
                                <label class="additional"
                                       for="ticket-min-per-order-${ticket.id}"><fmt:message
                                        key="editTicketsPromoCodes.min"/></label>
                                <input type="number" class="form-control" placeholder="1"
                                       value="1" name="ticket_min_per_order_${ticket.id}" value=""
                                       id="ticket-min-per-order-${ticket.id}" min="1"/>
                                <label class="additional"
                                       for="ticket-max-per-order-${ticket.id}"><fmt:message
                                        key="editTicketsPromoCodes.max"/></label>
                                <input type="number" class="form-control" placeholder="1"
